...
IFDEF SMBEDIT
IFDEF SMB2FIX
  JMP Wrapper_ReadWorldBackgroundColor_hijack
ELSE
  JMP ReadWorldBackgroundColor_hijack
ENDIF
ELSE
...
IFDEF SMBEDIT
IFDEF SMB2FIX
  JMP Wrapper_ReadWorldSpriteColor_hijack
ELSE
  JMP ReadWorldSpriteColor_hijack
ENDIF
ELSE
	; look up the address of the current world's palette
	LDY CurrentWorldTileset
...
IFDEF SMBEDIT
  JSR ReadLevelForegroundData_RegularObject_hijack_one
  JSR random_routine_02
ELSE
...
ReadLevelBackgroundData_ProcessObject_Advance3Bytes:
	INY
IFDEF SMBEDIT
  JMP ReadLevelBackgroundData_ProcessObject_Advance3Bytes_hijack
...
ReadLevelBackgroundData_ProcessObject_AdvanceByte:
  NOP
  JMP ReadLevelBackgroundData_ProcessObject_AdvanceByte_hijack
ELSE
...
.pad $9970, $FF
ReadLevelForegroundData_RegularObject_hijack_one:
  STA byte_RAM_E6
  RTS
...
.pad $9A90, $FF
ReadLevelBackgroundData_ProcessObject_Advance3Bytes_hijack:
  JSR random_routine_01
  JMP ReadLevelBackgroundData_ProcessObject_Advance2Bytes

.pad $9AB0, $FF
ReadLevelBackgroundData_ProcessObject_AdvanceByte_hijack:
  JSR random_routine_01
  INY
  JSR random_routine_01
  JMP ReadLevelBackgroundData_Object
...
lol:
  ...
  CLI
IFDEF SMB2FIX
  JMP Wrapper_ReadWorldBackgroundColor_hijack_back
ELSE
...
+
  ...
  CLI
IFDEF SMB2FIX
  JMP Wrapper_ReadWorldSpriteColor_hijack_back
ELSE
  JMP back_ReadWorldBackgroundColor
ENDIF

IFDEF SMB2FIX
Wrapper_ReadWorldSpriteColor_hijack:
  JSR Wrapper_DisableNMI
  JMP ReadWorldSpriteColor_hijack
Wrapper_ReadWorldSpriteColor_hijack_back:
  JSR Wrapper_RestoreNMI
  JMP back_ReadWorldBackgroundColor
ENDIF

IFDEF SMB2FIX
Wrapper_ReadWorldBackgroundColor_hijack:
  JSR Wrapper_DisableNMI
  JMP ReadWorldBackgroundColor_hijack
