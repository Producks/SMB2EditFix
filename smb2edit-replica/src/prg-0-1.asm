...
IFDEF SMBEDIT
  ...
  NOP
ELSE
	LDA #$78 ; SMB2EDIT JSR $95C3
	STA PlayerXLo ; STA $EA
ENDIF
	RTS
...
IFDEF SMBEDIT
  ...
  CPY #$00
  BEQ random_label_01
  LDA #$78 ; For rent address, who know's what this does
  STA PlayerXLo
  RTS
random_label_01:
  LDY CurrentLevel
  LDA $95E0, Y ; Grabbing from work ram, not sure what this is TODO
  STA PlayerXLo
  RTS
  .db $ff, $ff, $ff, $ff, $ff, $ff, $ff, $ff ; Probably free space
  .db $78, $78, $78, $78, $78, $78, $78, $78, $78, $78, $78, $78, $78, $78, $78, $78
  .db $78, $78, $78, $78 ; whatever this is lol?
ENDIF
