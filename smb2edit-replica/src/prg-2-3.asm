...
IFDEF SMBEDIT
  JMP CheckObjectHorizontalSpawnBoundaries_InitializePage_InitializeObject_hijack
  NOP
ELSE
	LDA (RawEnemyData), Y
...
CheckObjectHorizontalSpawnBoundaries_InitializePage_InitializeObject_back:
...
CheckObjectVerticalSpawnBoundaries_InitializePage_InitializeObject:
	; If bit 7 of the enemy type is set, it's already active and we should not re-initialize
IFDEF SMBEDIT
  JMP CheckObjectVerticalSpawnBoundaries_InitializePage_InitializeObject_hijack
  NOP
ELSE
	LDA (RawEnemyData), Y
...
CheckObjectVerticalSpawnBoundaries_InitializePage_InitializeObject_back:
...
IFDEF SMBEDIT
  ...
  NOP
  AND #$3f
  JSR CheckObjectSpawnBoundaries_InitializePage_MarkEnemyData_hijack
ELSE
...
unusedSpace $9EF0, $FF
IFDEF SMBEDIT
CheckObjectVerticalSpawnBoundaries_InitializePage_InitializeObject_hijack:
  LDA (RawEnemyData), Y
  CMP #$FE
  BNE +
  INY
...
+ 
  BMI +
  JMP CheckObjectVerticalSpawnBoundaries_InitializePage_InitializeObject_back
+ 
  JMP CheckObjectVerticalSpawnBoundaries_InitializePage_NextObject

  .db $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF ; padding

CheckObjectSpawnBoundaries_InitializePage_MarkEnemyData_hijack:
  DEY
  LDA (RawEnemyData), Y
  INY
  CMP #$FE
...
CheckObjectHorizontalSpawnBoundaries_InitializePage_InitializeObject_hijack:
  LDA (RawEnemyData), Y
  CMP #$FE
  BNE +
  INY
...
+
  BMI +
  JMP CheckObjectHorizontalSpawnBoundaries_InitializePage_InitializeObject_back
+
  JMP CheckObjectHorizontalSpawnBoundaries_InitializePage_NextObject
ENDIF
unusedSpace $A030, $FF
